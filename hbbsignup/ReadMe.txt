========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : hbbsignup
========================================================================


AppWizard が生成した hbbsignup には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには hbbsignup を構成している各ファイルの概要説明が含まれています。
...
hbbsignup.h
    ...
    みます） をインクルードし、また CHbbsignupApp アプリケーションクラスを宣
    言します。

hbbsignup.cpp
    このファイルは CHbbsignupApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\hbbsignup.ico
    ...
    ルです。このアイコンはリソース ファイル hbbsignup.rc によってインクルード
    されます。
...
hbbsignupDlg.h, hbbsignupDlg.cpp - ダイアログ
    これらのファイルは CHbbsignupDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な hbbsignup.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) hbbsignup.pch 
