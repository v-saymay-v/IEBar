========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : HBBHost
========================================================================


AppWizard が生成した HBBHost には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには HBBHost を構成している各ファイルの概要説明が含まれています。
...
HBBHost.h
    ...
    みます） をインクルードし、また CHBBHostApp アプリケーションクラスを宣
    言します。

HBBHost.cpp
    このファイルは CHBBHostApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\HBBHost.ico
    ...
    ルです。このアイコンはリソース ファイル HBBHost.rc によってインクルード
    されます。
...
HBBHostDlg.h, HBBHostDlg.cpp - ダイアログ
    これらのファイルは CHBBHostDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な HBBHost.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) HBBHost.pch 
