========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : hbbuninst
========================================================================


AppWizard が生成した hbbuninst には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには hbbuninst を構成している各ファイルの概要説明が含まれています。
...
hbbuninst.h
    ...
    みます） をインクルードし、また CHbbuninstApp アプリケーションクラスを宣
    言します。

hbbuninst.cpp
    このファイルは CHbbuninstApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\hbbuninst.ico
    ...
    ルです。このアイコンはリソース ファイル hbbuninst.rc によってインクルード
    されます。
...
hbbuninstDlg.h, hbbuninstDlg.cpp - ダイアログ
    これらのファイルは CHbbuninstDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な hbbuninst.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) hbbuninst.pch 
